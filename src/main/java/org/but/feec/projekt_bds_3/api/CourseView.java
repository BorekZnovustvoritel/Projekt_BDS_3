...
public class CourseView {
    ...
    public boolean getUserHasIt() {return this.userHasIt.get();}
    public void setUserHasIt(boolean userHasIt) {this.userHasIt.setValue(userHasIt);}
    public String getProgress() {return progress.get();}
    public void setProgress(String progress) {this.progress.setValue(progress);}
    public String getNextLesson() {return this.nextLesson.get();}
    public void setNextLesson(String link) {this.nextLesson.setValue(link);}
}
